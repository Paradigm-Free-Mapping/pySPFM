...
###########################################################
template-package: Distance-Dependence Motion-Related Artifact Analysis
###########################################################

The ``template-package`` package is a Python package for running template-package quality control analyses.

.. image:: https://img.shields.io/pypi/v/template-package.svg
   :target: https://pypi.python.org/pypi/template-package/
   :alt: Latest Version

.. image:: https://img.shields.io/pypi/pyversions/template-package.svg
   :target: https://pypi.python.org/pypi/template-package/
...
.. image:: https://readthedocs.org/projects/template-package/badge/?version=latest
...
``template-package`` is a Python implementation of the methods described in `Power et al. (2018)`_.
...
template-package is licensed under GNU Lesser General Public License version 2.1.
